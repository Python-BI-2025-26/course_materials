# HW 21. Инструменты разработчика

Мы познакомились с несколькими инструментами для усовершенствования наших тулов. Давайте их применим!

## Объект разработки

Мы будет усовершенствовать наш питоновский тул, а точнее, `FastQ`-фильтратор из него. Последний раз мы его трогали в ДЗ 16. От вас требуется смерджить все несмердженные ветки в `main` и создать новую ветку.
...
Главное - **независимо** от того с чем работаете, приложите ссылку на пулл-реквест в [гугл-форму](https://docs.google.com/forms/d/e/1FAIpQLSf9p8mfIEiF75jiPqDhS0Ou8iBuvF9Hu5PH_R8c5AZdl4tAqA/viewform?usp=publish-editor)
...
1. [*20 баллов*] Прием аргументов командной строки (`argparser` или `click`о) - столько аргументов сколько нужно
2. [*16 баллов*] Логгирование **в файл** (`logging` или `loguru`) -  должно логгироваться как минимум одно информационное сообщение и одна ошибка (по 8 баллов за каждое).
3. [*64 балла*] Тестирование (`unittest`, `pytest`) - нужно придумать и написать 8 тестов (по 8 баллов за каждый), которые будут удовлетворять след. условиям: 
